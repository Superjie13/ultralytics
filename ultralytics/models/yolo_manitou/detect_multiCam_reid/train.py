...
from ultralytics.nn.tasks import DetectionModel_MultiView_ReID
...
class ManitouTrainer_MultiCam_ReID(ManitouTrainer):
    """
    ...
    def get_validator(self):
        ...
        self.loss_names = "box_loss", "cls_loss", "dfl_loss", "reid_loss"
        return yolo_manitou.detect_multiCam_reid.ManitouValidator_MultiCam_ReID(
